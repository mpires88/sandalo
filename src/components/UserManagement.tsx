...
export default function UserManagement() {
  ...
  async function saveInvite() {
    if (!fName.trim() || !fEmail.trim() || !fPassword) {
      ...
      {loading ? (
        ...
        <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 8, overflow: 'hidden' }}>
          <div
            style={{
              display: 'grid',
              gridTemplateColumns: '1fr 100px 140px 130px 70px 60px',
              padding: '8px 18px',
              background: '#F5F0E8',
            ...
            return (
              <div
                ...
                style={{
                  ...
                  gridTemplateColumns: '1fr 100px 140px 130px 70px 60px',
                  padding: '12px 18px',
                  borderBottom: i < profiles.length - 1 ? `1px solid ${T.border}` : 'none',
                  alignItems: 'center',
              ...
              >
                ...
                <div
                  style={{
                    fontSize: 12,
                    color: linkedStaff ? T.charcoal : T.muted,
                    fontStyle: linkedStaff ? 'normal' : 'italic',
                    overflow: 'hidden',
                ...
                <div>
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      cursor: 'pointer',
                      background: p.is_active ? T.sage : T.border,
                      position: 'relative',
          ...
          {profiles.length === 0 && (
            <div style={{ padding: '32px', textAlign: 'center', fontSize: 13, color: T.muted }}>
          ...
          >
            ...
            <div style={{ padding: '18px 22px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div>
                ...
                <input style={inp} value={fName} onChange={e => setFName(e.target.value)} autoFocus />
              </div>
              <div>
              ...
              <div>
                ...
                <select
                  style={inp}
                  value={fRole}
                  onChange={e => setFRole(e.target.value as Profile['role'])}
                ...
                {editing?.role === 'super_admin' && (
                  <div style={{ fontSize: 11, color: T.muted, marginTop: 4 }}>
                    The Super Admin role can’t be changed here.
                  </div>
                )}
              </div>
              <div>
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            fontWeight: 500,
                            cursor: 'pointer',
                            border: sel ? `2px solid ${T.sage}` : `2px solid ${T.border}`,
                            background: sel ? `${T.sage}12` : '#fff',
                            color: sel ? T.sage : T.charcoal,
                            transition: 'all .15s',
                          }}
                        >
                          {g.name}
            ...
            >
              ...
              <button
                onClick={modal === 'invite' ? saveInvite : saveEdit}
                disabled={saving}
                style={{
                  background: T.sage,
                  color: '#fff',
