            ...
            DAYS.map((_, i) => {
              ...
              return r
                ? {
                    ...
                    open_time: ((r.open_time as string) ?? '09:00').slice(0, 5),
                    close_time: ((r.close_time as string) ?? '18:00').slice(0, 5),
                  }
    ...
    <div style={{ padding: '28px 32px', maxWidth: 620 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28 }}>
        ...
        <button
          ...
          style={{
            background: dirty ? T.sage : T.border,
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  cursor: 'pointer',
                  background: h.is_open ? T.sage : T.border,
                  position: 'relative',
                  transition: 'background .2s',
                }}
              >
              ...
              {h.is_open ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <TimeSelect
                    value={h.open_time}
                    onChange={v =>
                      update(h.day_of_week, {
                        open_time: v,
                        close_time: h.close_time && h.close_time <= v ? '' : h.close_time,
                      })
                    }
                  />
