      ...
      fields={[
        {
          ...
          description: 'Send a confirmation message when an appointment is booked',
          type: 'toggle',
        },
        {
          label: 'Reminder — 24 Hours',
          description: 'Remind clients 24 hours before their appointment',
          type: 'toggle',
        },
        {
          label: 'Reminder — 2 Hours',
          description: 'Send a same-day reminder 2 hours before the appointment',
          type: 'toggle',
        },
        {
          label: 'Cancellation Notice',
          description: 'Notify client and provider when an appointment is cancelled',
          type: 'toggle',
        },
